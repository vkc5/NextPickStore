...
mysqli_stmt_bind_param($itemsStmt, "ii", $orderId, $sellerId);
    ...
    <div class="main-layout">
        ...
        <aside class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="orders.php" class="active"><img src="../../assets/images/icons/seller icon/manifest.png" alt="" class="menu-icon-img"><span>Orders</span></a></li>
        ...
        <main class="content">
            ...
            <div class="card">
                ...
                <div class="table-wrap">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php } else { ?>
                                <tr>
                                    <td colspan="5" style="text-align:center; color:#777; padding:20px;">No order items found.</td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
                ...
                <div class="actions">
                    <a href="edit_order.php?order_id=<?php echo (int)$order['order_id']; ?>" class="btn btn-primary">Edit Order</a>
