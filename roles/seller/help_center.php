    ...
    <div class="main-layout">
        ...
        <aside class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="help_center.php" class="active"><img src="../../assets/images/icons/seller icon/customer-support.png" alt="" class="menu-icon-img"><span>Help Center</span></a></li>
