...
<head>
    ...
    <title>Manage Users - NextPick</title>
    <style>
        * {
            ...
            <main class="content">
                ...
                <div class="action-grid">
                    <a href="create_user.php" class="action-card">
                        <img src="../../../assets/images/icons/admin/UserAdd.png" alt="Create Users">
                        <span>Create Users</span>
                    </a>

                    <a href="update_users.php" class="action-card">
                        <img src="../../../assets/images/icons/admin/UserEdit.png" alt="Update Users">
                        <span>Update Users</span>
                    </a>

                    <a href="delete_users.php" class="action-card">
                        <img src="../../../assets/images/icons/admin/UserDelete.png" alt="Delete Users">
                        <span>Delete Users</span>
                    </a>

                    <a href="view_users.php" class="action-card">
                        <img src="../../../assets/images/icons/admin/UserView.png" alt="View Users">
