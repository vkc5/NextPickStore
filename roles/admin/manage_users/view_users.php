...
<head>
    ...
    <title>View Users - NextPick</title>
    <style>
        * {
...
<body>
    ...
    <script>
        ...
        function loadUsers() {
            ...
            fetch('../../../ajax/admin_user_view_search.php?' + params.toString())
                    ...
                    data.rows.forEach(user => {
                        html += `
                            <tr>
                                ...
                                <td>
                                    <a class="view-btn" href="view_user.php?id=${encodeURIComponent(user.user_id)}" title="View user">
                                        👁
                                    </a>
                                </td>
                            </tr>
