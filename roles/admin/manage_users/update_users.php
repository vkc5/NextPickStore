...
<html lang="en">
    <head>
        ...
        <title>Update Users - NextPick</title>
        <style>
            * {
    ...
    <body>
        ...
        <script>
            ...
            function loadUsers() {
                ...
                fetch('../../../ajax/admin_user_search.php?' + params.toString())
                        ...
                        `;
                            ...
                            data.rows.forEach(user => {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="edit-btn" href="edit_user.php?id=${encodeURIComponent(user.user_id)}">
