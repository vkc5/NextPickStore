...
<head>
    ...
    <title>Manage Products - NextPick</title>
    <style>
        ...
        <main class="content">
            ...
            <div class="action-grid">
                <a href="view_products.php" class="action-card">
                    <img src="../../../assets/images/icons/admin/box1.png" alt="View Products">
                    <span>View Products</span>
                </a>

                <a href="manage_comments.php" class="action-card">
                    <img src="../../../assets/images/icons/admin/comment.png" alt="Manage Comments">
